...
export function MedicalSummaryCard() {
  ...
  return (
    <div className="backdrop-blur-md bg-card/70 border border-border rounded-2xl p-5 mb-6 dark:bg-background/40 dark:border-white/10 dark:backdrop-blur-xl dark:shadow-[0_8px_32px_rgba(0,0,0,0.37)]">
          ...
          {summary && (
            <div className="space-y-6">
              <div className="grid grid-cols-3 gap-3">
                <div className="rounded-xl border border-border bg-card/60 p-3 text-center dark:bg-background/40 dark:border-white/10 dark:backdrop-blur-xl">
              ...
              <div>
                ...
                <ul className="mt-3 space-y-2">
                  {summary.recommendedQuestions.map((question) => (
                    <li
                      key={question}
                      className="flex items-start gap-2 rounded-xl border border-border bg-card/60 p-3 text-sm text-foreground dark:bg-background/40 dark:border-white/10 dark:backdrop-blur-xl"
                    >
                      <HugeiconsIcon
