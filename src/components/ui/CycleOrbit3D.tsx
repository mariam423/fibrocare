  ...
  return () => {
    ...
    scene.traverse((obj) => {
      ...
      for (const material of materials) {
        // SpriteMaterials carry a glow `map` texture that is NOT released
        // by `dispose()` — drop it explicitly so rapid SPA remounts do not
        // accumulate GPU textures.
  ...
  React.useEffect(() => {
    ...
    void import("three")
      .then((THREE) => {
        ...
        // Context creation can fail even after the probe succeeds — keep
        // the SVG fallback mounted instead of surfacing a rejected promise.
