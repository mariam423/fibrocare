 ...
 */
export function buildArticlePrompt(topic: ArticleTopic, signature: DoctorSignature): string {
...
- A short closing paragraph with the disclaimer: "${MEDICAL_DISCLAIMER}"
